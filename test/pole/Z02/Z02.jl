...
S = Dict{String,Any}("stype" => "sj", "nalph" => 14, "alpha" => 1e15)
#
setup_param(B, S)
...
# For [BASE] block
# See types.jl/_PBASE for default setup
B = Dict{String,Any}("finput" => "giw.12.data", "mtype" => "flat", "offdiag" => true)
#
# For [MaxEnt] block
# See types.jl/_PMaxEnt for default setup
S = Dict{String,Any}("nalph" => 14, "alpha" => 1e15)
#
setup_param(B, S, false)
...
# For [BASE] block
# See types.jl/_PBASE for default setup
B = Dict{String,Any}("finput" => "giw.21.data", "mtype" => "flat", "offdiag" => true)
#
# For [MaxEnt] block
# See types.jl/_PMaxEnt for default setup
S = Dict{String,Any}("nalph" => 14, "alpha" => 1e15)
